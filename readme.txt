The Spring.NET Social Facebook project, Release 1.0.0 (TO BE DEFINED)
---------------------------------------------------------------------
http://www.springframework.net/social-facebook/


1. INTRODUCTION

The 1.0.0 release of Spring.NET Social Facebook contains
	
	* A Spring.NET Social extension with connection support and an API binding for Facebook.


2. SUPPORTED FRAMEWORK VERSIONS

Spring.NET Social Facebook supports
...
Spring.NET Social Facebook is released under the terms of the Apache Software License (see license.txt).
...
Dependencies are those other than on the .NET BCL.
	...
	* "Spring.Social.Facebook" for all supported Framework versions
...
There is a Visual Studio solution file for each supported version
	* Spring.Social.Facebook.2008-NET20.sln for use with VS.NET 2008 and .NET 2.0
	* Spring.Social.Facebook.2008-NET35.sln for use with VS.NET 2008 and .NET 3.5
	* Spring.Social.Facebook.2010-NET40.sln for use with VS.NET 2010 and .NET 4.0
	* Spring.Social.Facebook.2010-WP70.sln  for use with VS.NET 2010 and Windows Phone 7.0 (Requires Windows Phone tools)
	* Spring.Social.Facebook.2010-WP71.sln  for use with VS.NET 2010 and Windows Phone 7.1 (Requires Windows Phone tools)
...
Bug, issue and project tracking can be found at https://jira.springsource.org/browse/SPRNETSOCIALFB

A source repository browser is located at https://fisheye.springsource.org/changelog/spring-net-social-facebook

A continuous intergration and build server is located at https://build.springframework.org/browse/SPRNETSOCIALFB

To get the sources, check them out at the git repository at https://github.com/SpringSource/spring-net-social-facebook using a git client to deal with line endings.
...
9. Contributing to Spring.NET Social Facebook
